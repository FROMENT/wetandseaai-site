...
cover:
  ...
  alt: "Apprentissage par Renforcement : Agent-Environnement et IA Moderne"
  caption: "IA & Travail"
draft: false
...
<div class="video-embed" style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;margin:1.5em 0">
  <iframe src="https://www.youtube.com/embed/han3j0KS6qM" title="Voir la vidéo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%"></iframe>
</div>
...
- `0:35` — Historique et impact mondial
- `1:08` — Différence avec l'apprentissage supervisé
- `1:43` — Les quatre piliers de l'AR
- `2:17` — La boucle agent-environnement
